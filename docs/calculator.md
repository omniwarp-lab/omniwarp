...
| Factorial   | `!`, `！` (Fullwidth)      | `5!` or `2.5!`                      | `2.5!`                      | `3.3233509705` | Exact integer factorials up to `170!`; non-integer floating-point factorials evaluated via Euler's Gamma function $x! = \Gamma(x + 1)$; negative integers or overflow return `Undefined` |
