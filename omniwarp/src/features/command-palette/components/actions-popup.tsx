...
import { ArrowUpDown, Copy, CornerDownLeft, Folder, Search, Shield } from 'lucide-react'
...
import { copyAppTargetPath, launchApp, openAppInExplorer } from '@/features/apps/commands'
